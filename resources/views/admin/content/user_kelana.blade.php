            ...
            <div class="row mt-2">
                <div class="col-md-12">
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border" id="nama_kecamatan">DATA USER OPERATOR KELANA</legend>
                                ...
                                <table class="table normal table2excel" data-tableName="Test Table 3">
                                    ...
                                    <tbody id="table-body">
                                        @foreach ($kecamatan as $d)
                                            <tr id="{{ $d->user->id }}">
                                                <td class="kecamatan">{{ $d->title }}</td>
                                                <td class="username">{{ $d->user->email ?? '-' }}</td>
                                                <td class="text-center px-2">
                                                    <div class="btn-group">
                                                        <span class="d-none">
                                                            {{ str_replace(' ', '', strtolower($d->title) . '.' . strtolower($d->title)) }}
                                                        </span>
