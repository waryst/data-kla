        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline p-2">
                <div class="card-header">
                    <h3 class="card-title">Detail Data Kelana Kecamatan {{ $kecamatan->title }} </h3>
                </div>
                <div class="card-body">
                            ...
                            @foreach ($data_kelana as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($item->filekelana->count() > 0)
                                            @if ($item->filekelana[0]->status == 1)
                                                <a href="{{ url('/file/Kelana') . '/' . $item->filekelana[0]->file }}"
