            ...
            <fieldset class="scheduler-border">
                ...
                <div class="col-12 my-2">
                    <div class="card">
                        ...
                        <h2 class="card-title mx-auto font-weight-bold">KECAMATAN {{ Str::upper($kecamatan->title) }}</h2>
                        <h2 class="card-title mx-auto">Data Per Desa</h2>
                            ...
                            <table id="example1" class="table table-head-fixed table-bordered table-hover text-wrap">
                                ...
                                <tbody>
                                    @foreach ($desa as $item)
                                        <?php
                                        $progress = round(($item->filedekela_count / $jml_dekela) * 100);
                                        if ($progress < 50) {
                                            $warna = 'bg-danger';
                                        } elseif ($progress < 70) {
                                            $warna = 'bg-warning';
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ url('detail_dekela/' . $item->id) }}">Desa
                                                    {{ $item->title }}</a></td>
                                            <td>
                                                <div class="progress progress-md">
                                                    <div class="progress-bar {{ $warna }}"
                                                        ...
                                                        <span
                                                            class="font-weight-bold">{{ $item->filedekela_count }}/{{ $jml_dekela }}
                                                            ({{ $progress }}%)
                                                        </span>
                                                    </div>
                                                </div>
