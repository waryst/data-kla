                ...
                <div class="card-body">
                    <div class="row justify-content-between">
                        <div class="card px-2 col-md-6 py-4">
                            @foreach ($dekela as $key => $item)
                                @if ($key <= floor(count($dekela) / 2))
                                    <div id="content{{ $item->id }}">
                                        @if ($item->filedekela_count > 0)
                                            <div class="input-group mb-2">
                                                @if ($item->filedekela[0]->status == 2)
                                                @else
                                                ...
                                                @if ($item->filedekela[0]->status == 0)
                                                    <div class="input-group-append">
                                                        <a href="#" class="btn btn-warning">Verifikasi</a>
                                                    </div>
                                                @elseif($item->filedekela[0]->status == 1)
                                                    <div class="input-group-append">
                                                ...
                                                @elseif($item->filedekela[0]->status == 2)
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <div class="input-group-append">
                                                            <a href="#"
                                                                onclick="show_note('{{ $item->filedekela[0]->id }}')"
